...
| 03 | IR exporter: beats -> scene JSON + manifest | next |
...
MIT — see [LICENSE](LICENSE). Game content belongs to MICA Team / Sunborn;
this repo ships code and tooling, not game assets.
